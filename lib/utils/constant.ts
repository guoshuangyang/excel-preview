...
export const defaultLeftNumberWidth = 40; // 侧边栏的宽度 - 纯内容的宽度
export const defaultTopNumberHeight = 20; // 顶部数字栏目的高度 - 纯内容的高度
export const defaultSelectBorderWidth = 1.2; // 选中的边框宽度
export const defaultBorderWidth = 1; // 边框的宽度
export const defaultFontFamily = "宋体"; // 默认单元格字体
...
// 颜色变浅
export const defaultActiveBackgroundColor = Color(defaultThemeColor)
  .lighten(0.999)
  .string(); // 选中的背景颜色
